 ...
 * @since 1.8
 */
final class PRTFNote extends PNote<StyledDocument,RTFEditorKit>{
	...
	public static class Productor{
		...
		private final PRTFTextAttachment attachment;
		private boolean lineWrap = true;
		private SerialParam serialParam = new SerialParam.Productor().product();
		
		public Productor(PRTFTextAttachment attachment){
		 ...
		 * @return 构造的富文本笔记。
		 */
		public PRTFNote product(){
			return new PRTFNote(attachment, lineWrap, serialParam);
		}
	}
	 ...
	 */
	private PRTFNote(PRTFTextAttachment attachment,boolean lineWrap,SerialParam sp){
	 ...
	 */
	@Override
	public Editor<PRTFNote> newEditor(){
	...
	private final class RTFNoteEditor extends AbstractEditor<PRTFNote> {
