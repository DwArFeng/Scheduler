...
final class W2SFCommonFunc{
	...
	static Project loadStruct0_0_0(ZipFile file) throws IOException, UnstructFailedException{
		...
		//解析文件
		PTagMap tagMap = unconstructTagsXML0_0_0(tagElement);
		PNotebookCol notebookCol = unconstructNotebooks0_0_0(notebooksElement);
	...
	static Project loadStruct0_1_0(ZipFile file) throws IOException,UnstructFailedException{
		...
		//解析文件
		PTagMap tagMap = unconstructTagsXML0_0_0(tagElement);
		PNotebookCol notebookCol = unconstructNotebooks0_1_0(notebooksElement);
		return new Project.Productor().tagMap(tagMap).notebookCol(notebookCol).product();
	}
	...
	static Project loadStruct0_2_0(ZipFile file) throws IOException,UnstructFailedException{
		...
		//解析文件
		PTagMap tagMap = unconstructTagsXML0_0_0(tagElement);
		PNotebookCol notebookCol = unconstructNotebooks0_2_0(notebooksElement);
		PImprovisedPlantCol improvisedPlantCol = unconstructImprovisedPlantsXML0_2_0(implantsElement);
	...
	static void saveStruct0_0_0(Project project, ZipOutputStream zout) throws IOException {
		...
		try {
			notesbooksXML = DocumentHelper.createDocument(constructNotebooksXML0_0_0(
					project.getChildFromType(PNotebookCol.class)
			));
	...
	static void saveStruct0_2_0(Project project, ZipOutputStream zout) throws IOException {
		...
		try {
			...
			implantsXML = DocumentHelper.createDocument(constructImprovisedPlantsXML0_2_0(
					project.getChildFromType(PImprovisedPlantCol.class)));
	...
	static void unzipFile0_0_0(Project project, ZipFile file, Scpath scpath) throws IOException {
		...
		try{
			//生成工作路径的输出流
			wout = SProjectIoHelper.getOutputStreamWC(project, scpath,true);
	...
	static void zipFile0_0_0(Project project, Scpath scpath, ZipOutputStream zout) throws IOException {
		...
		InputStream in = null;
		try{
			in = SProjectIoHelper.getInputStreamWC(project, scpath);
			Scpath thisVersionScpath = getScpathThisVersion0_0_0(scpath);
			String str = thisVersionScpath.getPathName();
			str = str.replace(File.separatorChar, '/');
	 ...
	 * @return 解析的TagID映射信息。
	 */
	static PTagMap unconstructTagsXML0_0_0(Element element){
		IDMap<PTag> map = new IDMap<PTag>();
		...
		while(iterator.hasNext()){
			...
			PTag tag = new PTag(name,describe);
			map.forcePut(id, tag);
		}
		return new PTagMap(map);
	 }
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructTagsXML0_0_0(PTagMap tagMap){
	 ...
	 * @return 解析出的笔记本。
	 */
	static PNotebookCol unconstructNotebooks0_0_0(Element element){
		List<PNotebook> notebooks = new Vector<PNotebook>();
		@SuppressWarnings("unchecked")
		...
		return new PNotebookCol.Productor().notebooks(notebooks).product();
	}
	 ...
	 * @return 解析出的笔记本。
	 */
	static PNotebookCol unconstructNotebooks0_1_0(Element element){
		List<PNotebook> notebooks = new Vector<PNotebook>();
		@SuppressWarnings("unchecked")
		List<Node> notebookNodes = element.selectNodes("/notebooks/notebook");
		Iterator<Node> iterator = notebookNodes.iterator();
	 ...
	 * @return 解析出的笔记本。
	 */
	static PNotebookCol unconstructNotebooks0_2_0(Element element){
		List<PNotebook> notebooks = new ArrayList<PNotebook>();
		@SuppressWarnings("unchecked")
		List<Node> notebookNodes = element.selectNodes("/notebooks/notebook");
		Iterator<Node> iterator = notebookNodes.iterator();
		while(iterator.hasNext()){
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructNotebooksXML0_0_0(PNotebookCol notebooks){
		Element element = DocumentHelper.createElement("notebooks");
		for(int i = 0 ; i < notebooks.getChildCount() ; i ++){
			PNotebook notebook = (PNotebook) notebooks.getChildAt(i);
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructNotebooksXML0_1_0(PNotebookCol notebooks){
		Element element = DocumentHelper.createElement("notebooks");
		for(int i = 0 ; i < notebooks.getChildCount() ; i ++){
			PNotebook notebook = (PNotebook) notebooks.getChildAt(i);
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructNotebooksXML0_2_0(PNotebookCol notebooks){
		Element element = DocumentHelper.createElement("notebooks");
		for(int i = 0 ; i < notebooks.getChildCount() ; i ++){
			PNotebook notebook = (PNotebook) notebooks.getChildAt(i);
	 ...
	 */
	static PNotebook unconstructNotebook0_0_0 (Element element){
		String name;
		String describe;
		List<Integer> ids = new Vector<Integer>();
		List<PNote<?,?>> notes = new Vector<PNote<?,?>>();
		...
		SerialParam sp = new SerialParam.Productor()
				...
				.tagIds(ids)
				.product();
		return new PNotebook.Productor().notes(notes).serialParam(sp).product();
	}
	 ...
	 * @return 解析的Notebook对象。
	 */
	static PNotebook unconstructNotebook0_1_0 (Element element){
		String name;
		String describe;
		List<Integer> ids = new Vector<Integer>();
		List<PNote<?,?>> notes = new Vector<PNote<?,?>>();
	 ...
	 * @return 解析的Notebook对象。
	 */
	static PNotebook unconstructNotebook0_2_0 (Element element){

		List<PNote<?,?>> notes = new ArrayList<PNote<?,?>>();
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructNotebookXML0_0_0(PNotebook notebook) {
		...
		for(int o = 0 ; o<notebook.getChildCount() ; o ++){
			PRTFNote note = (PRTFNote) notebook.getChildAt(o);
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructNotebookXML0_1_0(PNotebook notebook) {
		Element notebookElement = DocumentHelper.createElement("notebook");
		Element notebookNameElement = DocumentHelper.createElement("name");
		Element notebookDescribeElement = DocumentHelper.createElement("describe");
		notebookNameElement.addCDATA(notebook.getSerialParam().getName());
		...
		for(int o = 0 ; o<notebook.getChildCount() ; o ++){
			PNote<?,?> note = (PNote<?,?>) notebook.getChildAt(o);
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructNotebookXML0_2_0(PNotebook notebook) {
		Element notebookElement = DocumentHelper.createElement("notebook");
	 ...
	 * @return 解析的对象。
	 */
	static PRTFNote unconstructNote0_0_0(Element element){
		String name;
		String describe;
		List<Integer> ids = new Vector<Integer>();
		PRTFTextAttachment attachment;
		...
		attachment = new PRTFTextAttachment(getScpathLastVersion0_0_0( new Scpath(docElement.getText())));
		...
		SerialParam sp = new SerialParam.Productor()
				...
				.tagIds(ids)
				.product();
		return new PRTFNote.Productor(attachment).serialParam(sp).product();
	}
	 ...
	 * @return 解析的对象。
	 */
	static PNote<?,?> unconstructNote0_1_0(Element element){
		String type;
		String name;
		String describe;
		boolean lineWarp;
		...
		switch (type) {
			...
			default:
				PRTFTextAttachment attachment1 = new PRTFTextAttachment(getScpathLastVersion0_0_0( new Scpath(docElement.getText())));
				return new PRTFNote.Productor(attachment1).lineWrap(lineWarp).serialParam(sp).product();
		}
	}
	 ...
	 * @return 解析的对象。
	 */
	static PNote<?,?> unconstructNote0_2_0(Element element){
		String type;
		boolean lineWrap;
		SerialParam sp = new SerialParam.Productor().product();
		...
		switch (type) {
			...
			default:
				PRTFTextAttachment attachment1 = new PRTFTextAttachment(getScpathLastVersion0_0_0( new Scpath(docElement.getText())));
				return new PRTFNote.Productor(attachment1).lineWrap(lineWrap).serialParam(sp).product();
		}
	}
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructNoteXML0_0_0(PRTFNote note) {
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructNoteXML0_1_0(PNote<?,?> note) {
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructNoteXML0_2_0(PNote<?,?> note) {
	 ...
	 * @return 解析的即兴计划集合对象。
	 */
	static PImprovisedPlantCol unconstructImprovisedPlantsXML0_2_0(Element element){

		List<PImprovisedPlant> improvisedPlants = new ArrayList<PImprovisedPlant>();
		...
		return new PImprovisedPlantCol.Productor().improvisedPlains(improvisedPlants).product();
	}
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructImprovisedPlantsXML0_2_0(PImprovisedPlantCol improvisedPlantCol){
		Element notebookElement = DocumentHelper.createElement("implants");
		for(int o = 0 ; o<improvisedPlantCol.getChildCount() ; o ++){
			PImprovisedPlant improvisedPlant = (PImprovisedPlant) improvisedPlantCol.getChildAt(o);
	 ...
	 * @return 解析的即兴计划对象。
	 */
	static PImprovisedPlant unconstructImprovisedPlantXML0_2_0(Element element){
		boolean lineWrap;
		SerialParam sp = new SerialParam.Productor().product();
	 ...
	 * @return 构造的XML信息。
	 */
	static Element constructImprovisedPlantXML0_2_0(PImprovisedPlant improvisedPlant){
