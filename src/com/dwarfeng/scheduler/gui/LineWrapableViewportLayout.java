...
public class LineWrapableViewportLayout extends ViewportLayout{
	
	private static final long serialVersionUID = 8362817376434065358L;
		 ...
		 JViewport vp = (JViewport)parent;
	      ...
	      if (scrollableView != null) {
	          if (scrollableView.getScrollableTracksViewportWidth()) {
	          	...
	          	if(viewPrefSize.width < vpSize.width) viewSize.width = vpSize.width;
	          }
